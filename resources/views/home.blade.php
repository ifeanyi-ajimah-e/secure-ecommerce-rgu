...
<div class="row">
    <div class="col-lg-3">
        <div class="ibox ">
            ...
            <div class="ibox-content">
                <h1 class="no-margins"> {{  $data['adminCount'] }} </h1>
    ...
    <div class="col-lg-3">
        <div class="ibox ">
            <div class="ibox-title">
                <div class="ibox-tools">
                    <span class="label label-info float-right">Customer</span>
                </div>
                <h5>Total Customer</h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins"> {{  $data['customerCount']}} </h1>
    ...
    <div class="col-lg-3">
        <div class="ibox ">
            <div class="ibox-title">
                <div class="ibox-tools">
                    <span class="label label-primary float-right">Products </span>
                </div>
                <h5>Product Count </h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins"> {{   $data['productCount'] }} </h1>
